...
地球、云层和太阳采用 Solar System Scope 的公开纹理资源；银河背景为 Axel Mellinger 的 *Milky Way Panorama 2.0* 可见光实拍全景；月球、法线、镜面反射和夜景纹理来自 Three.js 公开示例资源。正式公开展示前，请按项目用途复核并保留最终素材的来源与授权说明。

## 边界

本版本不模拟真实时刻的天体位置或实时云图。地球为近景展示比例；太阳和月球维持接近相同的视直径，并放大至约 2.4° 以便观察，距离则为视觉深度而非真实轨道尺度。
